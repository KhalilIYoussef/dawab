...
const DEFAULT_ANIMAL_IMAGE = "https://images.unsplash.com/photo-1546445317-29f4545e9d53?auto=format&fit=crop&w=800&q=80";
...
const handleAnimalImageError = (e: React.SyntheticEvent<HTMLImageElement, Event>) => {
    e.currentTarget.src = DEFAULT_ANIMAL_IMAGE;
    e.currentTarget.onerror = null;
};
        ...
        return (
            <div className="space-y-6">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
                    <img 
                        src={selectedCycleForLogs.imageUrl} 
                        onError={handleAnimalImageError}
