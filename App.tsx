                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="border p-4 rounded-xl">
                                ...
                                <p className="text-xl font-bold text-gray-900">{totalTransactionsCount}</p>
                            </div>
                            <div className="border p-4 rounded-xl">
                                <p className="text-sm text-gray-500 mb-1">متوسط العملية</p>
                                <p className="text-xl font-bold text-gray-900">{totalTransactionsCount > 0 ? Math.round(totalGross/totalTransactionsCount).toLocaleString() : 0} ج.م</p>
                            </div>
                        </div>
                ...
                return (
                    <div className="space-y-4">
                        <div className="bg-white border border-green-200 shadow-sm p-6 rounded-2xl text-center">
                            ...
                            <p className="text-4xl font-bold text-gray-900">{totalRevenue.toLocaleString()} <span className="text-lg text-green-600 font-normal">ج.م</span></p>
                        </div>
                        <div className="bg-white border rounded-xl p-4">
                            ...
                            <div className="flex items-center justify-between text-sm bg-gray-50 p-3 rounded-lg font-mono" dir="ltr">
                                <span className="text-gray-900">{totalGross.toLocaleString()}</span>
                ...
                return (
                    <div className="space-y-4">
                        <div className="bg-white border border-blue-200 shadow-sm p-6 rounded-2xl text-center">
                            ...
                            <p className="text-4xl font-bold text-gray-900">{totalInsurancePool.toLocaleString()} <span className="text-lg text-blue-600 font-normal">ج.م</span></p>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                             <div className="border p-4 rounded-xl bg-gray-50">
                                <p className="text-sm text-gray-500 mb-1">العمليات المؤمنة</p>
                                <p className="text-xl font-bold text-gray-900">{insuredCount}</p>
                            </div>
                             <div className="border p-4 rounded-xl bg-gray-50">
                ...
                return (
                    <div className="space-y-5">
                         <div className="bg-white border border-purple-200 shadow-sm p-6 rounded-2xl text-center">
                            ...
                            <p className="text-4xl font-bold text-gray-900">{netCapitalDeployed.toLocaleString()} <span className="text-lg text-purple-600 font-normal">ج.م</span></p>
                        </div>
                        ...
                        <div className="relative border-r-2 border-gray-200 pr-6 mr-3 space-y-6">
                            <div className="relative">
                                ...
                                <p className="font-bold text-lg text-gray-900">{totalGross.toLocaleString()} ج.م</p>
                            </div>
    ...
    <div className="flex min-h-screen bg-[#f8f9fa] font-sans text-right" dir="rtl">
      ...
      >
          <div className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg flex items-start gap-3 border border-blue-100">
                  <UserCog size={24} className="text-blue-600 mt-1" />
                  <div>
                      <h4 className="font-bold text-blue-800 text-sm">صلاحية المدير</h4>
                      <p className="text-xs text-blue-700">أنت تقوم بإنشاء حساب جديد يدوياً. يجب إبلاغ المستخدم ببيانات الدخول (رقم الهاتف وكلمة المرور) بشكل آمن.</p>
                  </div>
              </div>
              ...
              <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                      <button
                          type="button"
                          onClick={() => setNewUserForm({...newUserForm, role: UserRole.INVESTOR})}
                          className={`p-3 rounded-lg border text-center transition-all ${newUserForm.role === UserRole.INVESTOR ? 'border-primary bg-green-50 text-primary font-bold' : 'border-gray-200 hover:bg-gray-50'}`}
                      >
                          مستثمر
                      </button>
                      <button
                          type="button"
                          onClick={() => setNewUserForm({...newUserForm, role: UserRole.BREEDER})}
                          className={`p-3 rounded-lg border text-center transition-all ${newUserForm.role === UserRole.BREEDER ? 'border-secondary bg-orange-50 text-secondary font-bold' : 'border-gray-200 hover:bg-gray-50'}`}
                      >
                          مربي
                      </button>
                  </div>
      ...
      `}>
        <div className="p-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src={LOGO_URL} alt="Dawab" className="w-12 h-12 object-contain" />
      ...
      <main className="flex-1 overflow-y-auto h-screen p-4 md:p-8">
        <header className="md:hidden flex justify-between items-center mb-6">
          <div className="flex items-center gap-3">
             <img src={LOGO_URL} alt="Dawab" className="w-8 h-8 object-contain" />
